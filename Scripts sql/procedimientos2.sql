...
drop procedure if exists modificarVehiculo2;
delimiter |

CREATE PROCEDURE modificarVehiculo2 (IN matriculaI VARCHAR(20), IN tipoI VARCHAR(50), IN marcaI VARCHAR(50),
IN añoI INT, IN nombre_modeloI VARCHAR(20), IN colorI VARCHAR(256), IN capacidadI INT, IN precioI FLOAT)
BEGIN
	UPDATE vehiculo
    SET tipo=tipoI, marca=marcaI, año=añoI, nombre_modelo=nombre_modeloI, color=colorI, capacidad=capacidadI,precio=precioI
	WHERE matricula=matriculaI;
END |
